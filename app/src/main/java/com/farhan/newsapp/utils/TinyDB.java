...
/**
 * Created by Farhan on 26,April,2019
 */
public class TinyDB {

    public static String NEWS = "newsData";
    private static String DB_NAME = "com.farhan.newsapp";
    ...
    public ArrayList<News> getListObject(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<News> objects =  new ArrayList<News>();

        for(String jObjString : objStrings){
            News value  = (News)gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<News> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
